    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          {/* Header principal: móvil = 2 filas (buscador amplio arriba; pedidos abajo) · desktop = 1 fila */}
          <div className="flex flex-col gap-2 py-3 lg:flex-row lg:items-center lg:justify-between lg:gap-0 lg:py-4">
            <div className="flex min-w-0 w-full items-center gap-2 lg:flex-1 lg:gap-0">
              {/* Logo */}
                  ...
                  <div className="relative">
                    {!isClient ? (
                      <img
                        src="/LOGO2.png"
                        alt="La Hornera"
                        className="h-12 sm:h-16 w-auto transition-transform duration-300 group-hover:scale-105 lg:h-auto"
                      />
                      ...
                      <img
                        src="/LOGO2.png"
                        alt="La Hornera"
                        className="h-14 w-auto max-h-[4.5rem] sm:h-16 transition-transform duration-300 group-hover:scale-105"
                      />
                    ) : (
                      <img
                        src="/LOGO2.png"
              ...
              {/* Buscador */}
              <div className="min-w-0 flex-1 mx-1 sm:mx-2 lg:mx-4 lg:max-w-4xl">
                <ProductSearch />
              </div>

              {/* Móvil: menú + opcional “En línea” */}
            ...
            {/* Móvil: Mis pedidos en segunda fila, ancho completo */}
            <button
              type="button"
              onClick={() => setIsShoppingListOpen(true)}
              className="flex w-full items-center justify-center gap-2 rounded-xl py-2.5 px-4 text-sm font-bold text-white shadow-sm hover:opacity-95 transition-opacity lg:hidden"
              style={{ backgroundColor: '#7f1d1d' }}
              title="Mis Pedidos"
